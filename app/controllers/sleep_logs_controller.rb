class SleepLogsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @sleep_log.save
        format.html { redirect_to @sleep_log, notice: 'Sleep log was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @sleep_log.update(sleep_log_params)
        format.html { redirect_to @sleep_log, notice: 'Sleep log was successfully updated.' }
