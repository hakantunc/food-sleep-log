class FoodLogsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @food_log.save
        format.html { redirect_to food_logs_path, notice: 'Food log was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @food_log.update(food_log_params)
        format.html { redirect_to food_logs_path, notice: 'Food log was successfully updated.' }
